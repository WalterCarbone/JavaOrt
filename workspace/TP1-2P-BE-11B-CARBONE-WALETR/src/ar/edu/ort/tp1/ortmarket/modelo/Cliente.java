...
public class Cliente {
	...
	private final static String MSJ_SALDO_INVALIDA = "El saldo es menor al minimo";
	private final static int MIN_SALDO = 0;
	 ...
	 * Dni: 6852741 Saldo: 60958.5510105 LISTO!!!!!
	 */
	public void imprimirHistorial() {
		
		Pila<String> aux = new PilaNodos<>();
		String mensaje = null;
		System.out.println("------------- Mostrando historial de:" + this.getRazonSocial());
